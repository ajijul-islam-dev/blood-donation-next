    ...
    <div className="bg-white py-20 md:py-28">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 ">
        <div className="relative">
          <div className="w-full h-full bg-[#F9FAFB] p-5 md:p-10 space-y-3 lg:space-y-5 text-[#333333] lg:absolute -bottom-12 -right-20 rounded-md hover:shadow-xl z-10 duration-300 ">
            ...
            <ul className=" space-y-1 lg:space-y-3 list-disc pl-5 md:pl-8">
